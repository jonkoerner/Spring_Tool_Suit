...
public class Users {
    ...
    public String registration(@Valid @ModelAttribute("user") User user, BindingResult result, Model model) {
        ...
        userService.saveWithUserCourse(user);
    ...
    public String newcourse() {
    	return "newCourses.jsp";
    	} 
    
//    
//    @PostMapping("/courses/create")
//    public String registrationCourses(@Valid @ModelAttribute("course") Course course, BindingResult result, Model model) {
//        courseValidator.validate(course, result);
//        if (result.hasErrors()) {
//            return "registrationPage.jsp";
//        }
//        courseService.saveWithUserCourse(course);
//        return "redirect:/login";
//    }
}
